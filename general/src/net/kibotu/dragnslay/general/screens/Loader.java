 ...
 *
 * @author <a href="https://github.com/Matsemann">Matsemann</a>
 * @user <a href="mailto:jan.rabe@wooga.net">Jan Rabe</a>
 */
public class Loader implements Screen {
    ...
    public void show () {
        ...
        Assets.manager.load( "data/loading.pack", TextureAtlas.class );
        ...
        TextureAtlas atlas = Assets.manager.get( "data/loading.pack", TextureAtlas.class );
    ...
    public void hide () {
        ...
        Assets.manager.unload( "data/loading.pack" );
    }
